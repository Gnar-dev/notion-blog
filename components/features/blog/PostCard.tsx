...
export function PostCard({ post }: PostCardProps) {
  return (
    <Card className="group bg-card/50 border-border/40 hover:border-primary/20 focus-within:ring-primary overflow-hidden border backdrop-blur-sm transition-all duration-300 focus-within:ring-2 focus-within:ring-offset-2 hover:scale-[1.02] hover:shadow-lg">
      {post.coverImage && (
